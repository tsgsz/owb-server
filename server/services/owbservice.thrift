namespace cpp owb.server.services

include "owb/server/models/owbop.thrift"
include "owb/server/models/owbsys.thrift"
...
service manager {
    ...
    owbsys.OwbServerInfo JoinMeeting(1:string uname, 2:string passwd, 3:string mid) throws (1:owbsys.OwbMissingMeeting mmiss, 2:owbsys.OwbDeadMeeting mdead);
